...
//        shortcutSetUp();
    ...
    private ObservableList<product> loadProducts() {
        ...
        try {
            String query = "SELECT * FROM stock where userID=" + user.getUserID();
            ...
            while (rs.next()) {
                product newProduct;
                try {
                    newProduct = new product(rs.getString(4), rs.getString(1), rs.getFloat(2), rs.getFloat(6), rs.getInt(5), rs.getString(3));
                } catch (Exception e) {
                    newProduct = new product(rs.getString(4), rs.getString(1), rs.getFloat(2), rs.getFloat(6), rs.getInt(5),"");
                }
    ...
    public void removeProduct() throws SQLException {
        ...
        for (product bean : products)
            if (bean.getCheckbox().isSelected()) {
                ...
                pst.setString(1, bean.getBarcode());
