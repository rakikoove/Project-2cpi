...
//        System.out.println("this is test in add   "+ProvidersComboBox.getValue().getFirstName()+"  "+ProvidersComboBox.getValue().getId());
       ...
       String barcode = this.barcode.getText();
        ...
        product product = new product(this.productname.getText(), barcode, sellPrice, buyPrice, quanity, expirationdateString);
    ...
    private boolean errorCheck() throws SQLException {
        ...
        if (rs.next()) {
            if (!rs.getString("name").equals(productname.getText()) && rs.getString("barcode").equals(barcode.getText())) {
                errorLabel.setTextFill(Paint.valueOf("red"));
    ...
    void SetThatWasAdded(String Barcode, Integer Id) throws SQLException {
