...
public class ApplyingCommandController implements Initializable {
    ...
    boolean IfInTable(Integer Barcode) throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            try {
                TheProduct = new product(resultSet.getString("name"), resultSet.getString("barcode"), resultSet.getFloat("buyprice"), resultSet.getFloat("sellprice"), resultSet.getInt("quantity"), resultSet.getDate("expirationdate").toString());
            } catch (Exception e) {
                TheProduct = new product(resultSet.getString("name"), resultSet.getString("barcode"), resultSet.getFloat("buyprice"), resultSet.getFloat("sellprice"), resultSet.getInt("quantity"), "");
            }
