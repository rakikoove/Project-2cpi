...
public class CommandHistoryController implements Initializable {
    ...
    public static HashMap<Integer, Command> CommandHashMap = new HashMap<Integer, Command>();
 ...
 */
        ...
        while (resultSet.next()) {
            ...
            CommandHashMap.get(ID).addListProducts(new product(resultSet.getString(2), resultSet.getString(6), resultSet.getInt(5), resultSet.getBoolean(3)));
