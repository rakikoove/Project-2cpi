...
public class SendEmailController implements Initializable {
    ...
    public static product theProduct /*= new product(this.productname.getText(), barcode, sellPrice, buyPrice, quanity, expirationdateString)*/;
...
//            String theDate=resultSet.getDate(3).toString();
            ...
            if (Percentage <= 20)
                NeededProduct.add(new product(resultSet.getString(4), resultSet.getString(1), resultSet.getFloat(2), resultSet.getInt(5), Percentage, resultSet.getBoolean(9), resultSet.getInt(8)));

            ProductList.add(new product(resultSet.getString(4), resultSet.getString(1), resultSet.getFloat(2), resultSet.getInt(5), Percentage, resultSet.getBoolean(9), resultSet.getInt(8)));
            TempoListOfProducts.add(new product(resultSet.getString(4), resultSet.getString(1), resultSet.getFloat(2), resultSet.getInt(5), Percentage, resultSet.getBoolean(9), resultSet.getInt(8)));
